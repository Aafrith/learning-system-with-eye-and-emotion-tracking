...
import { UserPlus, Mail, Lock, User, Loader2, Eye, EyeOff, GraduationCap, BookOpen, Shield } from 'lucide-react'
...
export default function SignupPage() {
  ...
  const roles = [
    { value: 'student' as UserRole, label: 'Student', icon: BookOpen, color: 'bg-blue-100 text-blue-600' },
    { value: 'teacher' as UserRole, label: 'Teacher', icon: GraduationCap, color: 'bg-purple-100 text-purple-600' },
    { value: 'admin' as UserRole, label: 'Admin', icon: Shield, color: 'bg-green-100 text-green-600' },
  ]

  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-success-50 flex items-center justify-center px-4 py-8">
      <motion.div
                ...
                {roles.map((role) => {
                  ...
                  return (
                    <button
                      ...
                      disabled={isLoading}
                    >
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center mb-1 ${role.color}`}>
